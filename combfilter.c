...
uint32_t Delay_Depth = 100; //default starting delay is 100000 is 0.5 sec approx.
 ...
 while(1)
 {
	...
	if (PUSH2_val==0)
		{   bcm2835_delay(100); //100ms delay for buttons debouncing. 
			if (Delay_Depth<DELAY_MAX)Delay_Depth=Delay_Depth+5000; //50000 is 250ms approx.
		}
           if (PUSH1_val==0) 
			{ 	
			    bcm2835_delay(100); //100ms delay for buttons debouncing. 
				if (Delay_Depth>DELAY_MIN)Delay_Depth=Delay_Depth-5000;
			}
	}
